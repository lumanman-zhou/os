...
void display_week(int year, int month , int day)
{
    ...
    switch(count)
        {
            case 0:printf("\033[32m\033[1m\t%d-%d-%d is Sunday\n\033[0m",year,month,day);break;
            case 1:printf("\033[32m\033[1m\t%d-%d-%d is Monday\n\033[0m",year,month,day);break;
            case 2:printf("\033[32m\033[1m\t%d-%d-%d is Tuesday\n\033[0m",year,month,day);break;
            case 3:printf("\033[32m\033[1m\t%d-%d-%d is Wednesday\n\033[0m",year,month,day);break;
            case 4:printf("\033[32m\033[1m\t%d-%d-%d is Thursday\n\033[0m",year,month,day);break;
            case 5:printf("\033[32m\033[1m\t%d-%d-%d is Friday\n\033[0m",year,month,day);break;
            case 6:printf("\033[32m\033[1m\t%d-%d-%d is Saturday\n\033[0m",year,month,day);break;
